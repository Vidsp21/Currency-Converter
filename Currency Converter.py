...
class App(tk.Tk): 
 ...
 def __init__(self, converter):
     ...
     self.configure(bg="#00C5CD")
     # Label
     self.intro_label = Label(self, text = "Welcome to Vidula's Currency Converter", fg = 'black', relief = tk.RAISED, justify = tk.CENTER, borderwidth = 3)
     self.intro_label.config(font = ('Times New Roman',15,'bold'))

     self.date_label = Label(self, text = f"1 Indian Rupee equals = {self.currency_converter.convert('INR','USD',1)} USD \n Date : {self.currency_converter.data['date']}", bg = 'white', relief = tk.GROOVE, borderwidth = 2)
     ...
     self.amount_field = Entry(self, bd = 3, bg = '#B0EFEF', relief = tk.RIDGE, justify = tk.CENTER, validate='key', validatecommand=valid)
     self.converted_amount_field_label = Label(self, text = '', fg = 'black', bg = '#B0EFEF', relief = tk.RIDGE, justify = tk.CENTER, width = 18, borderwidth = 3)
